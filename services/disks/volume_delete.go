...
const (
	volumeDeleteEndpoint = "/v1/volumes/%s"
)
...
func (r *VolumeDeleteRequest) Make(ctx context.Context, cli *clo.ApiClient) error {
...
func (r *VolumeDeleteRequest) buildRequest(ctx context.Context, cliOptions map[string]interface{}) (*http.Request, error) {
	...
	baseUrl += fmt.Sprintf(volumeDeleteEndpoint, r.VolumeID)
