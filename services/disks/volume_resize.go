...
const (
	volumeResizeEndpoint = "/v1/volumes/%s/extend"
)
...
func (r *VolumeResizeRequest) Make(ctx context.Context, cli *clo.ApiClient) error {
...
func (r *VolumeResizeRequest) buildRequest(ctx context.Context, cliOptions map[string]interface{}) (*http.Request, error) {
	...
	baseUrl += fmt.Sprintf(volumeResizeEndpoint, r.VolumeID)
	b := new(bytes.Buffer)
