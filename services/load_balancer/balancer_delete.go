...
const (
	balancerDeleteEndpoint = "/v1/loadbalancers/%s"
)
...
func (r *BalancerDeleteRequest) Make(ctx context.Context, cli *clo.ApiClient) error {
...
func (r *BalancerDeleteRequest) buildRequest(ctx context.Context, cliOptions map[string]interface{}) (*http.Request, error) {
	...
	baseUrl += fmt.Sprintf(balancerDeleteEndpoint, r.ServerID)
