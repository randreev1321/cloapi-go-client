...
const (
	balancerRulesCreateEndpoint = "/v1/loadbalancers/%s/rules"
)
...
func (r *BalancerRulesCreateRequest) Make(ctx context.Context, cli *clo.ApiClient) error {
...
func (r *BalancerRulesCreateRequest) buildRequest(ctx context.Context, cliOptions map[string]interface{}) (*http.Request, error) {
	...
	baseUrl += fmt.Sprintf(balancerRulesCreateEndpoint, r.BalancerID)
	b := new(bytes.Buffer)
