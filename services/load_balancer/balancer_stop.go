...
const (
	balancerStopEndpoint = "/v1/loadbalancers/%s/stop"
)
...
func (r *BalancerStopRequest) Make(ctx context.Context, cli *clo.ApiClient) error {
...
func (r *BalancerStopRequest) buildRequest(ctx context.Context, cliOptions map[string]interface{}) (*http.Request, error) {
	...
	baseUrl += fmt.Sprintf(balancerStopEndpoint, r.BalancerID)
