...
const (
	snapDeleteEndpoint = "/v1/snapshots/%s/delete"
)
...
func (r *SnapshotDeleteRequest) Make(ctx context.Context, cli *clo.ApiClient) error {
...
func (r *SnapshotDeleteRequest) buildRequest(ctx context.Context, cliOptions map[string]interface{}) (*http.Request, error) {
	...
	baseUrl += fmt.Sprintf(snapDeleteEndpoint, r.SnapshotID)
